            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br><br>
                        <table id="tabla-pregunta" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>Texto</th>
                                <th>TipoEncuesta</th>
                            ...
                            @foreach ($preguntas as $pregunta)
                                <tr data-id="{{$pregunta->id}}">
                                    ...
                                    <td>
                                        <button type="button" class="btn-delete btn btn-danger" onclick="avisoEliminar({{$pregunta->id}})" data-toggle="modal" data-target="#avisoEliminar">Eliminar</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>¿Desea eliminar la pregunta?&hellip;</p>
                                </div>
...
<script src="js/scriptpregunta.js"></script>