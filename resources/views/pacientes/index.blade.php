            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br><br>
                        <table id="tabla-paciente" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                           ...
                           @foreach ($pacientes as $paciente)
                               <tr data-id="{{$paciente->id}}">
                                   ...
                                   <td>
                                       <button type="button" class="btn-delete btn btn-danger" onclick="avisoEliminar({{$paciente->id}})" data-toggle="modal" data-target="#avisoEliminar">Eliminar</button>
                                   </td>
                               </tr>
                           @endforeach
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>¿Desea eliminar la paciente?&hellip;</p>
                                </div>
