            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br><br>
                        <table id="tabla-tipoencuesta"  class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>Nombre</th>
                           ...
                           @foreach ($tipoencuestas as $tipoencuesta)
                               <tr data-id="{{$tipoencuesta->id}}">
                                   ...
                                   <td>
                                       <button type="button" class="btn-delete btn btn-danger" onclick="avisoEliminar({{$tipoencuesta->id}})" data-toggle="modal" data-target="#avisoEliminar">Eliminar</button>
                                   </td>
                               </tr>
                           @endforeach
                           </tbody>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Eliminar Tipo Encuesta</h4>
                                </div>
                                <div class="modal-body">
                                    <p>¿Desea eliminar la tipo encuesta?&hellip;</p>
                                </div>
...
<script src="js/scripttipoencuesta.js"></script>