                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            <label for="codesas" class="col-md-4 control-label">Código Sas</label>

                            <div class="col-md-6">
                                <input id="codesas" type="text" class="form-control" name="codesas" value="{{ old('codesas') }}" required autofocus>

                                @if ($errors->has('codesas'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('codesas') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
