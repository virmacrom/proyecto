...
@section('content')
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       ...
                       <br><br>
                        <table id="tabla-sas" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>CodeSas</th>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Eliminar SAS</h4>
                                </div>
                                <div class="modal-body">
                                    <p>¿Desea eliminar la SAS?&hellip;</p>
                                </div>
    ...
    {!! Form::open(['route' => ['sas.destroy',':SAS_ID'], 'method' => 'delete','id'=>'form-delete']) !!}
    {!! Form::close() !!}
...
<script src="js/scriptsas.js"></script>