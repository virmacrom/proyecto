...
@section('content')
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br><br>
                        <table id="tabla-cita" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>Fecha</th>
                                <th>Medico</th>
                            ...
                            @foreach ($citas as $cita)
                                ...
                                <tr data-id="{{$cita->id}}">
                                    ...
                                    <td>
                                        <button type="button" class="btn-delete btn btn-danger" onclick="avisoEliminar({{$cita->id}})" data-toggle="modal" data-target="#avisoEliminar">Eliminar</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>¿Desea eliminar la Cita?&hellip;</p>
                                </div>
    ...
    {!! Form::open(['route' => ['citas.destroy',':CITA_ID'], 'method' => 'delete','id'=>'form-delete']) !!}
    {!! Form::close() !!}
@endsection
...
<script src="js/scriptcita.js"></script>
